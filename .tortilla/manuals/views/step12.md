...
#### [__Server__ Step 9.1: Add Query.users](https://github.com/Urigo/WhatsApp-Clone-Server/commit/9cd8cdbdfe2dceca1b62aa192857afa867407de3)

##### Changed schema&#x2F;resolvers.ts
```diff
@@ -83,6 +83,12 @@
 ┊83┊83┊
 ┊84┊84┊      return chat.participants.includes(currentUser.id) ? chat : null;
 ┊85┊85┊    },
+┊  ┊86┊
+┊  ┊87┊    users(root, args, { currentUser }) {
+┊  ┊88┊      if (!currentUser) return [];
+┊  ┊89┊
+┊  ┊90┊      return users.filter(u => u.id !== currentUser.id);
+┊  ┊91┊    },
 ┊86┊92┊  },
 ┊87┊93┊
 ┊88┊94┊  Mutation: {
...
#### [__Client__ Step 12.1: Add basic ChatCreationScreen](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/be69c87ddf2f3745827d738d83933c9f35c8b0e4)
...
#### [__Server__ Step 9.2: Add Mutation.addChat](https://github.com/Urigo/WhatsApp-Clone-Server/commit/45bd61b034369c64e48bb090c414260d21cdfed1)
...
#### [__Client__ Step 12.2: Create chat on user pick](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/420dd773ff42c33e2d647ff0445032c26ae7c628)
...
#### [__Server__ Step 9.3: Add Subscription.chatAdded](https://github.com/Urigo/WhatsApp-Clone-Server/commit/02e148be16100e94f790cb9fa30b547098f75e3a)
...
#### [__Client__ Step 12.3: Write chat on chatAdded](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/bfe216bf5495ce688df632bc6568b749a950b393)
...
@@ -52,6 +53,11 @@
 ...
 ┊54┊55┊        },
+┊  ┊56┊        update: (client, { data }) => {
+┊  ┊57┊          if (data && data.addChat) {
+┊  ┊58┊            writeChat(client, data.addChat);
+┊  ┊59┊          }
+┊  ┊60┊        },
 ┊55┊61┊      }).then(result => {
 ┊56┊62┊        if (result && result.data !== null) {
 ┊57┊63┊          history.push(`/chats/${result.data!.addChat!.id}`);
```
...
#### [__Server__ Step 9.4: Add Mutation.removeChat](https://github.com/Urigo/WhatsApp-Clone-Server/commit/93618ac632fbde6969ff9caa7247090f36f1bda7)
...
#### [__Client__ Step 12.4: Add chat removal function](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/00b8fbaaa86714af9f6e17f15d8ab36054a4bacc)
...
#### [__Server__ Step 9.5: Add Subscription.chatRemoved](https://github.com/Urigo/WhatsApp-Clone-Server/commit/b251fdb4afd51da95fb7e93316c9a5398888a8b9)
...
#### [__Client__ Step 12.5: Update cache on chat removal](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/c0e9fa1607ab73ececdc50be53f6abe8280151d9)
...
```diff
@@ -97,6 +98,11 @@
 ┊ 97┊ 98┊  if (loadingChat) return null;
 ┊ 98┊ 99┊  if (chat === null) return null;
 ┊ 99┊100┊
+┊   ┊101┊  // Chat was probably removed from cache by the subscription handler
+┊   ┊102┊  if (!chat) {
+┊   ┊103┊    return <Redirect to="/chats" />;
+┊   ┊104┊  }
+┊   ┊105┊
 ┊100┊106┊  return (
 ┊101┊107┊    <Container>
 ┊102┊108┊      <ChatNavbar chat={chat} history={history} />
```
