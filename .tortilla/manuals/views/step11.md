...
#### [__Server__ Step 8.1: Add User type](https://github.com/Urigo/WhatsApp-Clone-Server/commit/4745c54)
...
#### [__Server__ Step 8.2: Resolve queries in relation to current user](https://github.com/Urigo/WhatsApp-Clone-Server/commit/9d72a87)
...
#### [__Client__ Step 11.1: Distinguish messages](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/a53db45)
...
#### [__Client__ Step 11.2: Support credentials](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/725be12)
...
#### [__Server__ Step 8.4: Support credentials](https://github.com/Urigo/WhatsApp-Clone-Server/commit/f4d4da0)
...
#### [__Server__ Step 8.5: Use cookie parser](https://github.com/Urigo/WhatsApp-Clone-Server/commit/929a395)
...
#### [__Server__ Step 8.6: Define current user based on cookies](https://github.com/Urigo/WhatsApp-Clone-Server/commit/29041b9)
...
```diff
@@ -22,6 +22,7 @@
 ┊22┊22┊    "@graphql-codegen/typescript-resolvers": "1.2.1-alpha-3d654462.34",
...
+┊  ┊25┊    "@types/cookie": "0.3.3",
 ...
 ┊27┊28┊    "@types/graphql": "14.2.0",
```
```diff
@@ -39,6 +40,7 @@
 ┊39┊40┊    "apollo-server-express": "2.6.2",
 ┊40┊41┊    "apollo-server-testing": "2.6.2",
...
#### [__Client__ Step 11.3: Add basic auth.service](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/ab7f4a3)
...
#### [__Client__ Step 11.4: Add AuthScreen](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/d749767)
...
#### [__Client__ Step 11.5: Add sign-out button that ChatsNavbar](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/43cdb35)
...
#### [__Client__ Step 11.6: Add withAuth() route wrapper](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/11e7efa)
