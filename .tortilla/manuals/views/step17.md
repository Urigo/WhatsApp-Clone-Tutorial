...
#### [__Server__ Step 14.1: Deduplicate SQL queries](https://github.com/Urigo/WhatsApp-Clone-Server/commit/142e5e1bad2f5bc63055975505646db17bbed0ac)
...
#### [__Server__ Step 14.2: Cache current user object](https://github.com/Urigo/WhatsApp-Clone-Server/commit/d5a9b97b7f5dc6bb1b0ccf44a8304ed6d8442f2c)
...
#### [__Server__ Step 14.3: Separate db query from public API](https://github.com/Urigo/WhatsApp-Clone-Server/commit/39e43c47a9acf4023eb0cf530f931c94dbae0295)
...
#### [__Server__ Step 14.4: Separate findChatByUser](https://github.com/Urigo/WhatsApp-Clone-Server/commit/f12629ce62ee8622b59912cdce370c250949eb8a)
...
#### [__Server__ Step 14.5: Separate findChatById](https://github.com/Urigo/WhatsApp-Clone-Server/commit/acb6f46ce8c63847f6fe1afc92f2d2fd4385fa75)
...
#### [__Server__ Step 14.6: Use Dataloader in Chats](https://github.com/Urigo/WhatsApp-Clone-Server/commit/3a2ba6b0698c7e3ac01e33a677d5839f50fa3e9c)
...
@@ -50,6 +50,7 @@
 ┊50┊50┊    "cookie": "0.4.0",
 ┊51┊51┊    "cors": "2.8.5",
 ┊52┊52┊    "cookie-parser": "1.4.4",
+┊  ┊53┊    "dataloader": "1.4.0",
 ┊53┊54┊    "express": "4.17.1",
 ┊54┊55┊    "graphql": "14.5.3",
 ┊55┊56┊    "graphql-import": "0.7.1",
```
...
#### [__Server__ Step 14.7: Implement caching for Chats](https://github.com/Urigo/WhatsApp-Clone-Server/commit/3b64f87d44760b81007e26db3fcb9a24294da848)
...
#### [__Server__ Step 14.8: Write chats to the cache](https://github.com/Urigo/WhatsApp-Clone-Server/commit/9cf23e574fd886f080d738b83001f76f69fb0a3d)
...
#### [__Client__ Step 15.1: Implement prefetching](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/c73eae15a07cc470f9b1db1524014861250871ca)
...
#### [__Server__ Step 14.9: Add fake data](https://github.com/Urigo/WhatsApp-Clone-Server/commit/692de7fa7c8d9cc21d061fc7e1dcc6a4f57b0734)
...
@@ -25,6 +25,7 @@
 ...
 ┊27┊27┊    "@types/express": "4.17.1",
+┊  ┊28┊    "@types/faker": "4.1.5",
 ┊28┊29┊    "@types/graphql": "14.5.0",
 ┊29┊30┊    "@types/jest": "24.0.18",
 ┊30┊31┊    "@types/jsonwebtoken": "8.3.3",
```
```diff
@@ -51,7 +52,9 @@
 ┊51┊52┊    "cors": "2.8.5",
 ┊52┊53┊    "cookie-parser": "1.4.4",
 ┊53┊54┊    "dataloader": "1.4.0",
+┊  ┊55┊    "date-fns": "2.0.1",
 ┊54┊56┊    "express": "4.17.1",
+┊  ┊57┊    "faker": "4.1.0",
 ┊55┊58┊    "graphql": "14.5.3",
 ┊56┊59┊    "graphql-import": "0.7.1",
 ┊57┊60┊    "graphql-scalars": "1.0.1",
```
...
#### [__Server__ Step 14.11: Implement cursor-based pagination in messages](https://github.com/Urigo/WhatsApp-Clone-Server/commit/97b72db5ce7a27548bb6a3deaf21e800f709b1de)
...
#### [__Client__ Step 15.6: Apply MessagesResult type](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/45a11c797f57f5fada7ccab1ef95688a0ccbdca5)
...
#### [__Client__ Step 15.2: Basics for infinite scroll](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/cde88ab8e4be0ad1648bafb748b1d413bcca38c9)
...
#### [__Client__ Step 15.3: Prevent calling back once fetching is in progress](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/2410c30da46d99135480fc03af1bd0a3fb7f2b13)
...
#### [__Client__ Step 15.4: Allow to notify when finished](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/714a7da9e672049907dfe561e9966d730ab91d3c)
...
#### [__Client__ Step 15.5: Fetch only if there is more data](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/0f6ca2b6cd2de8c039b5508b4d86eeb8a275d3f3)
...
#### [__Client__ Step 15.7: Implement pagination with context and hooks](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/0066021c9292901afc6c6a22e5680c4fb565c836)
...
#### [__Client__ Step 15.8: Use pagination limit and after props](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/b2acdb99ec50b068edb701f85fefab4d79fcb0b5)
...
#### [__Client__ Step 15.9: Use ChatPaginationProvider](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/9d1fd6c00ccc899746194f04d58229803e2e9ad0)
...
@@ -178,4 +175,15 @@
 ...
 ┊179┊176┊};
 ┊180┊177┊
+┊   ┊178┊const ChatRoomScreen: React.FC<ChatRoomScreenParams> = ({
+┊   ┊179┊  history,
+┊   ┊180┊  chatId,
+┊   ┊181┊}) => {
+┊   ┊182┊  return (
+┊   ┊183┊    <ChatPaginationProvider>
+┊   ┊184┊      <ChatRoom history={history} chatId={chatId} />
+┊   ┊185┊    </ChatPaginationProvider>
+┊   ┊186┊  );
+┊   ┊187┊};
+┊   ┊188┊
 ┊181┊189┊export default ChatRoomScreen;
```
...
#### [__Client__ Step 15.10: Make use of infinite scroll in MessagesList component](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/c76b3bf7b3894c632f3e47cdfaf9c2a95a71cd90)
...
#### [__Client__ Step 15.11: Implement a hook responsible for scrolling](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/f6c4bc49b75bad53d6b08d19b25cd43b88c9ddb3)
...
#### [__Client__ Step 15.12: Implement pagination in ChatRoom component](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/53a2bd5ace9b0622aa2935606d8cfecf63bf50cd)
...
```diff
@@ -152,6 +152,14 @@
 ┊152┊152┊    [data, chatId, addMessage]
 ┊153┊153┊  );
 ┊154┊154┊
+┊   ┊155┊  useEffect(() => {
+┊   ┊156┊    if (!after) {
...
+┊   ┊158┊    }
+┊   ┊159┊
+┊   ┊160┊    // every time after changes its value, fetch more messages
+┊   ┊161┊  }, [after]);
+┊   ┊162┊
 ┊155┊163┊  if (data === undefined) {
 ┊156┊164┊    return null;
 ┊157┊165┊  }
```
```diff
@@ -169,7 +177,13 @@
 ┊169┊177┊  return (
 ┊170┊178┊    <Container>
 ┊171┊179┊      <ChatNavbar chat={chat} history={history} />
-┊172┊   ┊      {chat.messages && <MessagesList messages={chat.messages} />}
+┊   ┊180┊      {chat.messages && (
+┊   ┊181┊        <MessagesList
+┊   ┊182┊          messages={chat.messages.messages}
+┊   ┊183┊          hasMore={chat.messages.hasMore}
+┊   ┊184┊          loadMore={() => setAfter(chat.messages.cursor!)}
+┊   ┊185┊        />
+┊   ┊186┊      )}
 ┊173┊187┊      <MessageInput onSendMessage={onSendMessage} />
 ┊174┊188┊    </Container>
 ┊175┊189┊  );
```
...
#### [__Client__ Step 15.13: Use fetchMore to load more messages](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/0ee0e0ab406cf286295434fd14abbe8851c55fbd)
...
@@ -158,7 +158,30 @@
 ┊158┊158┊    }
 ┊159┊159┊
 ┊160┊160┊    // every time after changes its value, fetch more messages
-┊161┊   ┊  }, [after]);
+┊   ┊161┊    fetchMore({
+┊   ┊162┊      variables: {
+┊   ┊163┊        after,
+┊   ┊164┊        limit,
+┊   ┊165┊      },
+┊   ┊166┊      updateQuery(prev, { fetchMoreResult }) {
+┊   ┊167┊        const messages = [
+┊   ┊168┊          ...fetchMoreResult!.chat!.messages.messages,
+┊   ┊169┊          ...prev.chat!.messages.messages,
+┊   ┊170┊        ];
+┊   ┊171┊
+┊   ┊172┊        return {
+┊   ┊173┊          ...prev,
...
+┊   ┊175┊            ...prev.chat!,
+┊   ┊176┊            messages: {
+┊   ┊177┊              ...fetchMoreResult!.chat!.messages,
+┊   ┊178┊              messages,
+┊   ┊179┊            },
+┊   ┊180┊          },
+┊   ┊181┊        };
+┊   ┊182┊      },
+┊   ┊183┊    });
+┊   ┊184┊  }, [after, limit, fetchMore]);
 ┊162┊185┊
 ┊163┊186┊  if (data === undefined) {
 ┊164┊187┊    return null;
```
...
#### [__Client__ Step 15.14: Explore bundle size](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/522aa6bbfa633077e937f8220d941ec2c44c9fbf)

##### Changed package.json
```diff
@@ -50,7 +50,8 @@
 ┊50┊50┊    "test": "TZ=\"Asia/Jerusalem\" react-scripts test",
 ┊51┊51┊    "eject": "react-scripts eject",
 ┊52┊52┊    "codegen": "graphql-codegen",
-┊53┊  ┊    "format": "prettier \"**/*.{ts,tsx,css,graphql}\" --write"
+┊  ┊53┊    "format": "prettier \"**/*.{ts,tsx,css,graphql}\" --write",
+┊  ┊54┊    "size": "source-map-explorer 'build/static/js/*.js'"
 ┊54┊55┊  },
 ┊55┊56┊  "eslintConfig": {
 ┊56┊57┊    "extends": "react-app"
```
```diff
@@ -70,6 +71,7 @@
 ┊70┊71┊  "devDependencies": {
 ┊71┊72┊    "@testing-library/jest-dom": "4.1.0",
 ┊72┊73┊    "@testing-library/react": "9.1.3",
-┊73┊  ┊    "jest-fetch-mock": "2.1.2"
+┊  ┊74┊    "jest-fetch-mock": "2.1.2",
+┊  ┊75┊    "source-map-explorer": "2.0.1"
 ┊74┊76┊  }
 ┊75┊77┊}🚫↵
```
...
#### [__Client__ Step 15.15: Replace moment with date-fns](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/fa839a1da7c47533323fc69d8bb5722b95416d76)

##### Changed package.json
```diff
@@ -30,9 +30,9 @@
 ┊30┊30┊    "graphql": "14.5.3",
...
#### [__Server__ Step 14.12: Produce transpiled code](https://github.com/Urigo/WhatsApp-Clone-Server/commit/5c2cda1e787a0de90aa64b5e4c2acb3afdc4df58)
...
#### [__Server__ Step 14.13: Prepare for production](https://github.com/Urigo/WhatsApp-Clone-Server/commit/2ba052ac5b8e3681cf64a18b01e1b5eb1e67c927)
...
#### [__Server__ Step 14.15: Add artillery config](https://github.com/Urigo/WhatsApp-Clone-Server/commit/91b4d6b593bba63402cc65fd7b87ec0a0c2e365a)
...
#### [__Server__ Step 14.16: Artillery config to find a limit](https://github.com/Urigo/WhatsApp-Clone-Server/commit/12ff5aa78968795084f64e582fde6670a72143d9)
...
#### [__Server__ Step 14.17: Add loadtest scripts](https://github.com/Urigo/WhatsApp-Clone-Server/commit/0b50b0ed53cc19d3f3dadcd0e308c227d7964119)
