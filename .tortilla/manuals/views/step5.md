...
#### [__Client__ Step 5.1: Add data-testid attributes](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/269bded)
...
#### [__Client__ Step 5.2: Setup tests](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/56fa612)
...
#### [__Client__ Step 5.3: Test ChatsList](https://github.com/Urigo/WhatsApp-Clone-Client-React/commit/176e397)
...
#### [__Server__ Step 3.1: Install and configure Jest](https://github.com/Urigo/WhatsApp-Clone-Server/commit/edcc1f0)
...
+┊  ┊16┊  },
 ...
 ┊17┊21┊    "@types/graphql": "14.2.0",
 ┊18┊22┊    "@types/graphql-iso-date": "3.3.1",
+┊  ┊23┊    "@types/jest": "24.0.13",
 ┊19┊24┊    "@types/node": "12.0.7",
+┊  ┊25┊    "jest": "24.8.0",
+┊  ┊26┊    "jest-junit": "6.4.0",
 ┊20┊27┊    "prettier": "1.18.1",
+┊  ┊28┊    "ts-jest": "24.0.2",
 ┊21┊29┊    "ts-node": "8.2.0",
 ┊22┊30┊    "typescript": "3.5.1"
 ┊23┊31┊  },
```
```diff
@@ -30,5 +38,19 @@
...
#### [__Server__ Step 3.2: Test Query.chats](https://github.com/Urigo/WhatsApp-Clone-Server/commit/25756e8)
